 ...
 * A  Utility to Initialise Xbox Controllers on Linux
 * Copyright 2021 Rick Timmis <ricktimmis68@gmail.com>
 *
 * Based upon original code for 'fftest'
 ...
 * Rick Timmis <ricktimmis68@gmail.com>
 */
...
int main(int argc, char** argv)
{
	...
	for (i=1; i<argc; ++i) {
		if (strncmp(argv[i], "--help", 64) == 0) {
			...
			printf("Initialises Xbox Controller\n");
            printf("---------------------------\n");
			exit(1);
		}
		else {
